  ...
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title pull-left">Cash Turnover Form by <strong><?php echo $fname." ".$lname; ?></strong> for <span id="drivername"></span></h4>
          <h4 class="modal-title pull-right">Location: <?php echo $cooperatives[0]->loc_name; ?></h4>
        </div>
        <div class="modal-body clearfix">
          ...
          <div class="col-sm-6 col-xs-12">
            <table class="table table-bordered" id="table-driverturnoverform">
              <tbody id="act_table">
