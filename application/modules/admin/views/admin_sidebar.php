<aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="payroll.php"><i class="fa fa-credit-card"></i><span>Payroll</span></a></li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="register_by_employee.php"><i class="fa fa-users"></i> By Employee</a></li>
                <li><a href="register_by_unit.php"><i class="fa fa-car"></i> By Unit</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu" style="display: none;">
                <li><a href="update_by_employee.php"><i class="fa fa-users"></i> By Employee</a></li>
                <li><a href="update_by_unit.php"><i class="fa fa-car"></i> By Unit</a></li>
              </ul>
            </li>
