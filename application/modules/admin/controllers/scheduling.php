...
Class Scheduling extends MY_Controller {
	...
	public function index() {
		$data['module'] = 'admin';
		$data['view_file'] = 'scheduling_view';
    	$data['sidebar'] = 'admin/admin_sidebar';

    	$data['css'] = $this->add_css(array(DataTablesCSS, DataTablesJSCSS, Select2CSS));
		$data['js'] = $this->add_js(array(DataTablesJS, DataTablesBSJS, Select2JS, SchedulingJS));	

    	$cooperatives = $this->SchedulingModel->select_where(3, 'coo_no, coo_name');
	...
	// 	$cooperatives = $this->SchedulingModel->dispatcher_detail('emp_no, coo_no, coo_name');
	// 	$data['cooperatives'] = $cooperatives;
